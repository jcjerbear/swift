...
struct Dream: Equatable {
    ...
    enum Creature: Equatable {
        ...
        var image: UIImage {
            // Devin: These strings do NOT flow to user-facing UI, so they
            // don't need to be warned about.
            let name: String
            switch self {
        ...
        var name: String {
            switch self {
                case .unicorn(.yellow):
                  // return NSLocalizedString("Yellow unicorn", comment: "A unicorn of color yellow")
                  // Devin: Removed localization and returning un-localized string.
                  return "Yellow unicorn"
                case .unicorn(.pink):
                  return NSLocalizedString("Pink unicorn", comment: "A unicorn of color pink")
                case .unicorn(.white):
                  return NSLocalizedString("White unicorn", comment: "A unicorn of color white")
                case .crusty:
                  return NSLocalizedString("Crusty", comment: "A funny name connoting a crotchety old man")
                case .shark:
                  return NSLocalizedString("Shark", comment: "The animal that lives in the sea")
                case .dragon:
                  return NSLocalizedString("Dragon", comment: "The mythical creature")
            }
        }
